...
%payoff of an ATFT player interacting with an ATFT player and an ALLD
...
%
function [pay] = DiffPayAtftDAlld(a,b,w,e)

c = 1;

% analytic expression for V(Alld|Atft) from SI

ExPayDAlldVsAtft = (1-e)*b*(1-w*a+w*(1-a))./(1-w*a-(1-a)*w^2);

% analytic expression for V(Atft|Atft) from SI
...
pay = ExPayAtftVsAtft - ExPayDAlldVsAtft;
